                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                {!! Form::open(['route' => array('passwordreset',$token,$isMobile),'class'=>'auth-reset-password-form mt-2','id'=>'reset_form','name'=>'reset_form','method'=>"POST"]) !!}
                                @csrf
    ...
    $("#reset_form").validate({
        rules: {
            ...
            submitHandler: function(form) {
                 if($("#reset_form").validate().checkForm()){
